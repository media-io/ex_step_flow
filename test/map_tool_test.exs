defmodule StepFlow.MapToolTest do
  ...
  test "replace_by_atom" do
    ...
    assert StepFlow.Map.replace_by_atom(source_1, :key_1, "new_value_1") == %{key_1: "new_value_1"}
    assert StepFlow.Map.replace_by_atom(source_2, :key_2, "new_value_2") == %{key_2: "new_value_2"}
  end
